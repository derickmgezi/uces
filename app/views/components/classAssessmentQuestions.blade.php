...
<form class="table-responsive" method="post" action="assessClass">
    <table class="table table-hover table-striped">
        ...
        <?php 
        $list_of_questions = AssessmentQuestion::where('section','D')
                                                ->where('week',$week)
        ...
        <tr hidden>
            <td colspan="" align="center">
                ...
                <input class="pull-left" type="text" name="assignment_id" value="{{$assignment_id}}" >
                <input type="text" name="week" value="{{$week}}" >
                <input type="text" name="semister" value="{{$assessment_detail->semester}}" >
                <input class="pull-right" type="text" name="academic_year" value="{{$academic_year->yr}}" ></td>
        </tr>
    </table>
</form>